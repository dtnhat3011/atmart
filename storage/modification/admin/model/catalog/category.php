...
if (!empty($data['filter_parent_id'])) {
	...
	public function 
				getTotalCategories($data = array())
				 {
		$sql = "SELECT COUNT(DISTINCT c1.category_id) AS total FROM " . DB_PREFIX . "category c1 LEFT JOIN " . DB_PREFIX . "category_description cd1 ON (c1.category_id = cd1.category_id)";
